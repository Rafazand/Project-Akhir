<div class="lime-sidebar">
    <div class="lime-sidebar-inner slimscroll">
        <ul class="accordion-menu">
            ...
            <li class="page">
                <a href="profile.html"><i class="material-icons">person_outline</i>Laporan<i class="material-icons has-sub-menu">keyboard_arrow_left</i></a>
                <ul class="sub-menu">
                    <li>
                        <a href="/Laporan/BuatLaporan">Buat Laporan</a>
                    </li>
                    <li>
                        <a href="/Laporan/TrackLaporan">Track Laporan</a>
                    </li>
                </ul>
            </li>
